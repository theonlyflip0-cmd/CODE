...
export const DEMO_MENU_ROWS: DemoMenuRow[] = [
  ...
  d("water", "Munzur Water 0,5L", "Munzur Water 0.5L", 2.0, 4, true),
  d("ayran", "Yayık Ayran", "Yayık Ayran", 2.0, 5, true),
  d("ayran-kers", "Ayran Kers", "Cherry Ayran", 2.5, 6, true),
  d("ayran-raibi-pistache", "Raïbi Pistache", "Raïbi Pistachio", 2.5, 7, true),
  d("raibi-granaatappel", "Raïbi Granaatappel", "Raïbi Pomegranate", 2.5, 8, true),
  // sauzen
